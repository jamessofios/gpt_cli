...
//	printf("%d\n", strlen(json_object_to_json_string(root)));
//	return 5;
  CURLcode ret;
  CURL *hnd;
  ...
  slist1 = curl_slist_append(slist1, "Authorization: Bearer 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");
...
//  curl_easy_setopt(hnd, CURLOPT_SSH_KNOWNHOSTS, "/home/james5/.ssh/known_hosts");
