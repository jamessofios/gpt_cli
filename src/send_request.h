...
char* send_request(const char *restrict url, const char *restrict api_key, const char *restrict json_str, enum argument_detection *args_detect) __attribute_malloc__;
